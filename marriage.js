...
setText(
"civilTitle",
"1. Requirements for New Civil Marriage Registration"
);
...
setText(
"civilReq4",
"ሁለቱም ተጋቢዎች የታደሰ መታወቂያ ወይም ፓስፖርት (ዋናና ኮፒ) በአካል መቅረብ አለባቸው።"
);
...
setText(
"civilReq7",
"ከሚስት 2 እና ከባል 2 በድምሩ 4 ምስክሮች በታደሰ መታወቂያ ወይም ፓስፖርት በአካል መቅረብ አለባቸው።"
);
...
setText(
"civilReq3",
"Applicants from outside Addis Ababa must provide a renewed ID card and Fayda."
);
...
setText(
"civilReq7",
"Ragaa baatota afur (lama gama dhiiraa fi lama gama dubartii) eenyummaa ykn paaspoortii qabanii qaamaan dhiyaachuu qabu."
);
...
setText(
"tradReq5",
"The husband and wife must provide two recent 3×4 passport-size photographs each."
);
...
// ===============================
// PART 5
// BACK BUTTON + FINAL LANGUAGE LOAD
// ===============================
...
languageBox.value = savedLanguage;
